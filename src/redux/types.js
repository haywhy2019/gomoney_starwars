...
export const SEARCH_PEOPLE_FAIL = "SEARCH_PEOPLE_FAIL";

export const SEARCH_PLANET_REQUEST = "SEARCH_PLANET_REQUEST";
export const SEARCH_PLANET_SUCCESS = "SEARCH_PLANET_SUCCESS";
export const SEARCH_PLANET_FAIL = "SEARCH_PLANET_FAIL";

export const SEARCH_SHIPS_REQUEST = "SEARCH_SHIPS_REQUEST";
export const SEARCH_SHIPS_SUCCESS = "SEARCH_SHIPS_SUCCESS";
export const SEARCH_SHIPS_FAIL = "SEARCH_SHIPS_FAIL";