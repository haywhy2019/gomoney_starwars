      ...
      <Container className="my-5">
        <Row>
          <Col md="12" className="text-center">
            {" "}
            <p className={`mt-3 ${style.heading}`}>Recently viewed {content}</p>
          </Col>
        </Row>
        <Row className="text-center py-5">
          <Col className={style.contain}>
            {content === "ship" ? (
              <Col className={style.recent} md="12" sm="12">
                {ships &&
                  ships.data.results
              ...
              <Col className={style.recent} md="12">
                {planet &&
                  planet.data.results
              ...
              <Col md="12" className={style.recentPeople}>
                {people &&
                  people.data.results
